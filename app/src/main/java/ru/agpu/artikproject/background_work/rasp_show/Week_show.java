    ...
    public Week_show(Context context){
        try{
            ...
            if (r.getCount()!=0) {
                ...
                week_para_view.addView(timeRow);
                do{
                    ...
                    if (r.getString(3).equals("0")){
                        ...
                        week_para_view.addView(tableRow); // Добавление столбца в таблицу
            ...
            e.printStackTrace();
            main_text.setText(R.string.rasp_error);
        }
    }
}
