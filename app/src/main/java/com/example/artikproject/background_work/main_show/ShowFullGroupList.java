        ...
        try{
            act.runOnUiThread(() -> {
                ...
                cdd.list_view.setOnItemClickListener((parent, v, pos, id) ->{
                    ...
                    cdd2.show();
                    ArrayAdapter<String> adapter2 = new ArrayAdapter(act.getApplicationContext(), R.layout.listviewadapterbl, GetFullGroupList_Online.faculties_group_name.get(pos));
                    cdd2.list_view.setAdapter(adapter2);
                    cdd2.list_view.setOnItemClickListener((parent2, v2, pos2, id2) ->{
                        MainActivity.selectedItem = GetFullGroupList_Online.faculties_group_name.get(pos).get(pos2);
                        MainActivity.selectedItem_type = "Group";
                        MainActivity.selectedItem_id = GetFullGroupList_Online.faculties_group_id.get(pos).get(pos2);
